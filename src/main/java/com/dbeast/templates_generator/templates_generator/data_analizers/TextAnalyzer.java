...
public class TextAnalyzer extends AbstractAnalyzer implements IAnalyzer {
    ...
    public TextAnalyzer(List<DateFormatsPOJO> dateFormats, final List<String> mappingChangeLog) {
        super(
                Arrays.asList(EFieldTypes.TEXT),
                new LinkedList<>(),
                Arrays.asList(EFieldTypes.BOOLEAN, EFieldTypes.KEYWORD, EFieldTypes.FLOAT, EFieldTypes.DOUBLE, EFieldTypes.TEXT_AND_KEYWORD,
                        EFieldTypes.INTEGER, EFieldTypes.LONG, EFieldTypes.DATE, EFieldTypes.IP),
...
//            case IP:
//            default:
//                logger.info("Field: " + key + " changed from " + ((FieldTypePropertiesPOJO) schema.get(key)).enumType() + " to " + EFieldTypes.TEXT);
//                schema.put(key, new FieldTypePropertiesPOJO(EFieldTypes.TEXT));
//        }
//    }
